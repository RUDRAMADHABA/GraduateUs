...
const UserDetailsbody = () => {
  // Example user data
  const allUserData = [
    { username: 'Soham Samantaray', email: 'john@example.com', status: 'premium', querylink:"https://firebase.com" },
    { username: 'Soham Samantaray', email: 'jane@example.com', status: 'general', querylink:"https://firebase.com" },
    { username: 'Soham Samantaray', email: 'john@example.com', status: 'general', querylink:"https://firebase.com" },
    { username: 'Soham Samantaray', email: 'jane@example.com', status: 'premium', querylink:"https://firebase.com" },
    { username: 'Soham Samantaray', email: 'john@example.com', status: 'general', querylink:"https://firebase.com" },
    { username: 'Soham Samantaray', email: 'jane@example.com', status: 'general', querylink:"https://firebase.com" },
    { username: 'Soham Samantaray', email: 'jane@example.com', status: 'premium', querylink:"https://firebase.com" },
  ];
