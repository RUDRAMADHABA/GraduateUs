  ...
  return (
    <>
      <Stack marginTop={{ sm: "105px", md: "125px" }} marginLeft={{ sm: "106px", md: "303px" }} justifyContent="center" paddingBottom="20px" >
        <Box sx={{ display: "flex", justifyContent: "center",flexDirection:"column",gap:"80px",alignItems:{xs:"flex-start",md:"center"}}}>
          ...
          <Box sx={{ width: "60vw", height: "100vh", margin: "0 1em", display: "flex", flexDirection: "column" }}>
            <Box sx={{ width: "100%", height: "50vh" }}>
              <Typography sx={{ color: props.head, fontSize: "25px", fontWeight: "700" }}>Check Attendance Report</Typography>
              ...
              <Typography sx={{  color: props.head, fontSize: "22px", fontWeight: "700",paddingBottom:"40px"}}>Keep Up the Good work !</Typography>
            </Box>
          </Box>
        </Box>
      </Stack>
