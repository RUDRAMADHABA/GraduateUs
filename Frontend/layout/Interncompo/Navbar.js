...
export default function MiniDrawer(props) {
            ...
            >
              <Link href="/home">
                ...
                <Box
                  ...
                  className={isDarkMode ? styles.hover : styles.hover2}
                >
                  <HomeIcon
 ...
 <Avatar
 sx={{
   width: { xs: "1.5em", md: "2.5em" },
   height: { xs: "1.5em", md: "2.5em" },
   overflow: "hidden",
 }}
...
/>
              ...
              >
                <>
                  <MenuItem onClick={handleClose}>
                    <Avatar />{" "}
                    <Link href="/editprofile" style={{ color: letter }}>
                      Edit Profile
                    </Link>
                  </MenuItem>
                  <MenuItem
        ...
        >
          ...
          {remove && (
            ...
            >
              <InputBase
                sx={{ ml: 1, flex: 1, color: "#1e1e1e !important" }}
                placeholder="Search"
                classes={{ input: "MuiInputBase-input" }}
              />
              <IconButton
                type="button"
                sx={{ p: "10px", color: "#525151" }}
                aria-label="search"
              >
                {/* <MicIcon /> */}
                <SearchIcon/>
          ...
          <List>
            {[
              <Link
                href="/chat"
                style={{ textDecoration: "inherit", color: letter }}
              >
                Chat
              </Link>,
                ...
                >
                  ...
                  >
                    ...
                    <Link href="/alumni">
                      {" "}
                      {index === 1 && (
                        <DescriptionIcon sx={{ color: letter }} />
                      )}
                    </Link>
                    <Link href="/alumni">
                      {index === 2 && (
                        <SensorOccupiedIcon sx={{ color: letter }} />
                      )}
                    </Link>
                    <Link href="/editprofile">
                      {index === 3 && <AccountBoxIcon sx={{ color: letter }} />}
                    </Link>
                    <Link href="/Premiumfeature">
                      {index === 4 && (
                        <SubscriptionsIcon sx={{ color: letter }} />
                      )}
                    </Link>
                  ...
                  <ListItemText
                    primary={text}
                    sx={{ opacity: open ? 1 : 0, color: letter }}
                  />
                </ListItemButton>
              </ListItem>
            ))}
          ...
          <Divider
            sx={{ borderColor: "#d2d2d2",margin:"30px 0px",marginTop:"100px" }}
          />
          <FormGroup
            sx={{
              marginLeft: "1em",
