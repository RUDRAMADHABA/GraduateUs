...
const Signup = () => {
  ...
  const handleOpen = async () => {
    ...
    const response = await axios.post(
      "https://graduate-us-backend-gkli.onrender.com/user/register/",
      {
        name: fname,
        email: email,
        password: pwd,
          ...
          <Grid container sx={{ color: "#fff" }}>
            <Grid item xs={15} md={5.7}>
              ...
              {/* <Stack justifyContent={"center"} paddingLeft={"80px"} gap={"15px"} sx={{ width: "80vw" }}>
									...
									<Stack onClick={handleGoogleSignIn} justifyContent={"space-evenly"} flexDirection={"row"} sx={{ background: '#ffffff', color: "#000", maxWidth: "400px", borderRadius: "10px", padding: "10px" ,cursor:"pointer"}}>
              ...
              <Toolbar sx={{ position: "relative", marginTop: "20px" }}>
                ...
                <Typography sx={{ fontSize: "12px", opacity: "0.65" }}>
                  I have read all and agree with all the Terms and conditions
                  and Privacy policy
                </Typography>
              </Toolbar>
              <br />
